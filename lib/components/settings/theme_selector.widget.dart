...
class _ThemeSelectorWidgetState extends State<ThemeSelectorWidget> {
  ...
  @override
  void initState() {
    theme = widget.pref.getString('globalMode') ?? 'system';
    lightTheme = widget.pref.getString('lightTheme') ?? 'light';
  ...
  void changeThemes(String systemStyle, String darkStyle) {
    ...
    BlocProvider.of<GlobalSettingsBloc>(context)
        .add(ChangeTheme(globalMode: systemStyle, darkMode: 1, lightMode: 1));
  }
  ...
  StatefulBuilder _dialog(BuildContext context) {
    ...
    return StatefulBuilder(builder: (localContext, localSetState) {
      ...
      void changeLightStyle(String value) {}
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _subtitle(S.current.lightMode),
              _listLightStyle(lightStyle, changeLightStyle),
              _subtitle(S.current.darkMode),
  ...
  Column _listLightStyle(String lightStyle, void Function(String) changeValue) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        RadioListTile(
